...
class JobController extends Controller
{
    ...
    {//edit
        ...
        if ($request->input('assignee') && $request->input('assignee')!='undefined') {
        ...
        if ($request->input('status') && $request->input('status')!='undefined') {
    ...
    {//mail all the assignes about their assigned and onprogress tasks
        $user = User::where('id', $id)->first();
        $jobs = Job::select('id')
